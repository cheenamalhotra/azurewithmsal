...
export let encryptionChangePromptDescription = 'mssql extension for VS Code now has encryption enabled by default for all SQL Server connections. This may result in your existing connections no longer working unless certain Encryption related connection properties are changed. We recommend you visit the link below for more information.';
export let moreInformation = 'More information';
...
export let startIpAddressPrompt = 'Start IP';
export let endIpAddressPrompt = 'End IP';
...
export let authTypeAzureActiveDirectory = 'Azure Active Directory - Universal w/ MFA Support';
...
export let azureMicrosoftAccount = 'Microsoft Account';
...
export let azureChooseAccount = 'Choose an Azure Active Directory Account';
export let azureAddAccount = 'Add an Account...';
export let cannotConnect = 'Cannot connect due to expired tokens. Please re-authenticate and try again.';
export let aad = 'AAD';
export let azureChooseTenant = 'Choose an Azure tenant';
...
export let msgPromptRetryFirewallRuleNotSignedIn = 'Your client IP address does not have access to the server. Add an Azure account and create a new firewall rule to enable access.';
export let msgPromptRetryFirewallRuleSignedIn = 'Account signed In. Create new firewall rule? ';
export let msgPromptRetryFirewallRuleAdded = 'Firewall rule successfully added. Retry profile creation? ';
export let msgAccountRefreshFailed = 'Credential Error: Account credentials have expired. Please re-authenticate.';
...
export let msgRefreshTokenNotNeeded = 'No need to refresh Azure acccount token for connection {0} with uri {1}';
...
export let loadLocalizedConstants = (locale: string) => {
	...
	encryptionChangePromptDescription = localize('encryptionChangePromptDescription', 'mssql extension for VS Code now has encryption enabled by default for all SQL Server connections. This may result in your existing connections no longer working unless certain Encryption related connection properties are changed. We recommend you visit the link below for more information.');
	moreInformation = localize('moreInformation', 'More information');
	...
	startIpAddressPrompt = localize('startIpAddressPrompt', 'Start IP');
	endIpAddressPrompt = localize('endIpAddressPrompt', 'End IP');
	...
	authTypeAzureActiveDirectory = localize('authTypeAzureActiveDirectory', 'Azure Active Directory - Universal w/ MFA Support');
	...
	azureMicrosoftAccount = localize('azureMicrosoftAccount', 'Microsoft Account');
	...
	azureChooseAccount = localize('azureChooseAccount', 'Choose an Azure Active Directory Account');
	azureAddAccount = localize('azureAddAccount', 'Add an Account...');
	cannotConnect = localize('cannotConnect', 'Cannot connect due to expired tokens. Please re-authenticate and try again.');
	aad = localize('aad', 'AAD');
	azureChooseTenant = localize('azureChooseTenant', 'Choose an Azure tenant');
	...
	msgPromptRetryFirewallRuleNotSignedIn = localize('msgPromptRetryFirewallRuleNotSignedIn', 'Your client IP address does not have access to the server. Add an Azure account and create a new firewall rule to enable access.');
	msgPromptRetryFirewallRuleSignedIn = localize('msgPromptRetryFirewallRuleSignedIn', 'Account signed In. Create new firewall rule? ');
	...
	msgAccountRefreshFailed = localize('msgAccountRefreshFailed', 'Credential Error: Account credentials have expired. Please re-authenticate.');
	...
	msgRefreshTokenNotNeeded = localize('msgRefreshTokenNotNeeded', 'No need to refresh Azure acccount token for connection {0} with uri {1}');
