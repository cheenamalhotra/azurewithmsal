 ...
 */
export function getPicklistLabel(connCreds: IConnectionInfo, itemType: Interfaces.CredentialsQuickPickItemType): string | undefined {
 ...
 */
export function getPicklistDetails(connCreds: IConnectionInfo): string | undefined {
