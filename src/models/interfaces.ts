...
export interface IConnectionProfile extends vscodeMssql.IConnectionInfo {
	...
	emptyPasswordInput: boolean | undefined;
	azureAuthType: AzureAuthType | undefined;
	accountStore: AccountStore | undefined;
	isValidProfile(): boolean | undefined;
	isAzureActiveDirectory(): boolean | undefined;
}
...
export interface IConnectionCredentialsQuickPickItem extends vscode.QuickPickItem {
	connectionCreds: vscodeMssql.IConnectionInfo | undefined;
...
export class ResultSetSummary {
	id: number | undefined;
	rowCount: number | undefined;
	columnInfo: IDbColumn[] | undefined;
}

export class BatchSummary {
	id: number | undefined;
	selection: ISelectionData | undefined;
	resultSetSummaries: ResultSetSummary[] | undefined;
	executionElapsed: string | undefined;
...
export interface IRange {
	selectNodeContents(el: any): void;
	/**
